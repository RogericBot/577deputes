...
%  Les parties EN et ES sont, à ce stade, des squelettes (\input{en}, \input{es}).
%==============================================================================
...
\date{\today\\[2pt]\small Version 1.0}
...
\small Ce document accompagne le dépôt Zenodo \texttt{[DOI à insérer]}. Le script
de calcul des analyses de sensibilité (\code{scripts/methodo\_sensitivity.py}) et
les tableaux de sortie sont joints au dépôt. Toute erreur ou imprécision peut être
signalée via le canal de contact du site (\code{/.well-known/security.txt}).
\normalsize
...
%==============================================================================
\input{en}   % Partie II — English version (squelette à ce stade)
\input{es}   % Partie III — Versión en español (esqueleto en esta etapa)
%==============================================================================
